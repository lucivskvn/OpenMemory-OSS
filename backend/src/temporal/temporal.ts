...
export function extractTemporalMetadata(
    ...
    logger.info("[TEMPORAL] No temporal metadata extractable for type", {
        mimeType,
    });
    return null;
}
 ...
 */
export function validateTemporalMetadata(
    metadata: any,
): metadata is MediaTemporal {
...
function extractImageTemporalMetadata(
    buffer: ArrayBuffer,
    extractedAt: string,
): ImageTemporal | null {
...
function extractAudioTemporalMetadata(
    buffer: ArrayBuffer,
    extractedAt: string,
): AudioTemporal | null {
...
function extractVideoTemporalMetadata(
    buffer: ArrayBuffer,
    extractedAt: string,
): VideoTemporal {
