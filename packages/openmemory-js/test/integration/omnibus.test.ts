...
async function cleanup(userId: string) {
    // Only cleanup for this test context if using file-based DB, 
    // but omnibus deletes EVERYTHING to be sure of clean slate in its own file.
...
describe("Omnibus Integration End-to-End", () => {
    let mem: Memory;
    const DB_PATH = getUniqueDbPath("omnibus");
