...
export default function Sidebar() {
  ...
  const navItems = [
    ...
    },
    {
      label: "Telemetry",
      path: "/telemetry",
      icon: <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="size-6"><path strokeLinecap="round" strokeLinejoin="round" d="M12 6v6l4 2" /></svg>
    },
    {
      label: "Settings",
      path: "/settings",
