...
describe("Keyword Extraction (keyword.ts)", () => {
    describe("extract_keywords - Basic Extraction", () => {
        test("extracts single-word keywords (canonicalized/stemmed)", () => {
            ...
            expect(keywords.has("programm") || keywords.has("programming")).toBe(true);
    ...
    describe("keyword_filter_memories - Memory Filtering", () => {
        ...
        test("weights different scoring components appropriately", async () => {
            ...
            const memories = [
                ...
                { id: "keywords", content: "machine and learning and algorithm separately" }, // keywords only
    ...
    describe("Integration - Real-World Scenarios", () => {
        test("handles technical documentation search", async () => {
            ...
            const memories = [
                { id: "1", content: "React hooks like useEffect allow side effects in functional components" },
                { id: "2", content: "Vue.js composition API is similar to React hooks" },
                { id: "3", content: "Class components use lifecycle methods instead of hooks" }
            ];
        ...
        test("handles multi-word technical terms", async () => {
            ...
            const memories = [
                { id: "1", content: "Deep neural networks are used in machine learning" },
                { id: "2", content: "Traditional algorithms don't need neural networks" }
            ];
