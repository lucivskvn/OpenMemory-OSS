...
async function basicExample() {
  ...
  try {
    ...
    console.log(
      `✅ Memory stored in ${memory1.primary_sector} sector:`,
      memory1.id,
    );
    ...
    console.log(
      `✅ Memory stored in ${memory2.primary_sector} sector:`,
      memory2.id,
    );
    ...
    console.log(
      `✅ Memory stored in ${memory3.primary_sector} sector:`,
      memory3.id,
    );
    ...
    results.matches.forEach((match, i) => {
      console.log(
        `   ${i + 1}. [${match.primary_sector}] ${match.content.substring(0, 50)}...`,
      );
      console.log(
        `      Score: ${match.score.toFixed(3)}, Salience: ${match.salience.toFixed(3)}`,
      );
    });
