    ...
    <div className="min-h-screen" suppressHydrationWarning>
      ...
      >
        ...
        <fieldset className="space-y-2 border border-stone-900 rounded-3xl px-4 pb-4 pt-1">
          ...
          >
            <div
              className="size-3 rounded-full bg-sky-500"
              suppressHydrationWarning
            ></div>
        ...
        <fieldset className="space-y-2 border border-stone-900 rounded-3xl px-5 pb-4 pt-4 flex justify-center items-center col-span-2">
          ...
          >
            <div
              className="rounded-xl border border-emerald-500/15 p-2 text-emerald-500 bg-emerald-500/10 text-center"
              suppressHydrationWarning
            >
            ...
            <div
              className="rounded-xl border border-sky-500/15 p-2 text-sky-500 bg-sky-500/10 text-center"
              suppressHydrationWarning
            >
              <div className="text-xl font-bold" suppressHydrationWarning>
            ...
            <div
              className="rounded-xl border border-amber-500/15 p-2 text-amber-500 bg-amber-500/10 text-center"
              suppressHydrationWarning
            >
              <div className="text-xl font-bold" suppressHydrationWarning>
                {events.filter((e) => e.type === 'decay').length}
              </div>
              <div className="text-xs mt-1" suppressHydrationWarning>
                Decay
              </div>
            ...
            <div
              className="rounded-xl border border-purple-500/15 p-2 text-purple-500 bg-purple-500/10 text-center"
              suppressHydrationWarning
            >
              <div className="text-xl font-bold" suppressHydrationWarning>
                {events.filter((e) => e.type === 'reflect').length}
              </div>
              <div className="text-xs mt-1" suppressHydrationWarning>
                Reflect
              </div>
        ...
        {}
        <div
          className="col-span-3 rounded-xl border border-stone-900 p-2 h-fit"
          suppressHydrationWarning
        >
          <h2 className="text-xl p-2 text-white">System Status</h2>
          <div
            className="rounded-xl w-full p-3 bg-stone-950/50 border border-stone-900 flex items-start justify-between mt-2 space-x-2"
            suppressHydrationWarning
          >
            <div
            ...
            >
              <div
                className="rounded-xl border border-emerald-500/15 p-2 text-emerald-500 bg-emerald-500/10"
                suppressHydrationWarning
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
              ...
              <div className="flex flex-col" suppressHydrationWarning>
                ...
                <span className="text-stone-300">
                  Memory system running smoothly. No issues detected.
                </span>
              </div>
            </div>
        ...
        {}
        <div
          className="col-span-6 rounded-xl border border-stone-900 p-4"
          suppressHydrationWarning
        >
          ...
          {loading && (
            <div
              className="text-stone-400 text-center py-8"
              suppressHydrationWarning
            >
              Loading...
            </div>
          ...
          {error && (
            <div
              className="text-rose-400 text-center py-8"
              suppressHydrationWarning
            >
              Error: {error}
            </div>
              ...
              <div className="space-y-4">
                {filtered.map((evt) => (
                  <div key={evt.id} className="relative pl-16">
                    {}
                    <div
                      className={`absolute left-4 top-2 w-4 h-4 rounded-full bg-${typecolors[evt.type]}-500 border-4 border-black`}
                    />
                      ...
                      <div className="flex items-start justify-between">
                        <div className="flex-1">
                          <div className="flex items-center gap-2 mb-2">
                            <span
                              className={`text-xs px-2 py-1 rounded-lg bg-${typecolors[evt.type]}-500/10 text-${typecolors[evt.type]}-500 border border-${typecolors[evt.type]}-500/20 capitalize`}
                            >
                              {evt.type}
                            </span>
                        ...
                        <svg
                          ...
                          strokeWidth="1.5"
                          stroke="currentColor"
                          className="size-5 text-stone-600 group-hover:text-stone-400 transition-colors ml-4"
                        >
                          <path
                            strokeLinecap="round"
                            strokeLinejoin="round"
