...
import { addTemporalTag, extractTemporalMetadata, getTemporalTimeline, validateTemporalMetadata, type MediaTemporal, type TemporalTimelineEntry, type Memory } from "../../backend/src/temporal/temporal.js";
...
describe("Temporal Tagging Module", () => {
    ...
    describe("getTemporalTimeline", () => {
        ...
        it("should filter out non-matching types", () => {
            ...
            const mockGetTemporalTimeline = vi.fn((userId: string, start: string, end: string, types?: string[]) => [
                {
                    memoryId: "mock-1",
                    userId,
                    timestamp: new Date().toISOString(),
            ...
            const result = mockGetTemporalTimeline(userId, startTime, endTime, ["video"]);
